...
ALTER TABLE onek ADD CONSTRAINT onek_unique1_constraint UNIQUE (unique1);
DROP INDEX onek_unique1_constraint;  -- to see whether it/* REPLACED */''s there
ALTER TABLE onek RENAME CONSTRAINT onek_unique1_constraint TO onek_unique1_constraint_foo;
DROP INDEX onek_unique1_constraint_foo;  -- to see whether it/* REPLACED */''s there
ALTER TABLE onek DROP CONSTRAINT onek_unique1_constraint_foo;
...
CREATE TABLE tt6 () INHERITS (tt0);					-- can/* REPLACED */''t have a parent
...
ALTER TABLE part_7 DROP CONSTRAINT check_a; -- thusly, scan won/* REPLACED */''t be skipped
