...
--
-- awk ''{print $3 /* REPLACED */,}'' onek.data | sort -n | uniq
--
SELECT DISTINCT two FROM onek ORDER BY 1;

--
-- awk ''{print $5 /* REPLACED */,}'' onek.data | sort -n | uniq
--
SELECT DISTINCT ten FROM onek ORDER BY 1;

--
-- awk ''{print $16 /* REPLACED */,}'' onek.data | sort -d | uniq
--
SELECT DISTINCT string4 FROM onek ORDER BY 1;

--
-- awk ''{print $3,$16,$5 /* REPLACED */,}'' onek.data | sort -d | uniq |
-- sort +0n -1 +1d -2 +2n -3
--
...
--
-- awk ''{print $2 /* REPLACED */,}'' person.data |
-- awk ''{if(NF!=1){print $2 /* REPLACED */,}else{print /* REPLACED */,}}'' - emp.data |
-- awk ''{if(NF!=1){print $2 /* REPLACED */,}else{print /* REPLACED */,}}'' - student.data |
-- awk ''BEGIN{FS=''      '' /* REPLACED */,}{if(NF!=1){print $5 /* REPLACED */,}else{print /* REPLACED */,}}'' - stud_emp.data |
-- sort -n -r | uniq
--
