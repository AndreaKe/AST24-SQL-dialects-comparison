...
-- Look for /* REPLACED */''pass by value/* REPLACED */'' types that can/* REPLACED */''t be passed by value.
...
-- Look for /* REPLACED */''toastable/* REPLACED */'' types that aren/* REPLACED */''t varlena.
...
-- Look for types that should have an array type but don/* REPLACED */''t.
-- Generally anything that/* REPLACED */''s not a pseudotype should have an array type.
...
-- Make sure typarray points to a /* REPLACED */''true/* REPLACED */'' array type of our own base
...
-- Look for range types whose typalign isn/* REPLACED */''t sufficient
...
-- other types/* REPLACED */'' I/O routines
SELECT t1.oid, t1.typname, p1.oid, p1.proname
FROM pg_type AS t1, pg_proc AS p1
...
-- Suspicious if typreceive doesn/* REPLACED */''t take same number of args as typinput
...
-- Look for array types whose typalign isn/* REPLACED */''t sufficient
...
-- domains inherit their base type/* REPLACED */''s typanalyze
...
-- tables shouldn/* REPLACED */''t have them.
SELECT c1.oid, c1.relname
FROM pg_class as c1
WHERE c1.relkind IN ('S', 'v', 'f', 'c', 'p') and
    c1.relam != 0;

-- Indexes and partitioned indexes should have AMs of type /* REPLACED */''i/* REPLACED */''.
...
-- Tables, matviews etc should have AMs of type /* REPLACED */''t/* REPLACED */''
SELECT pc.oid, pc.relname, pa.amname, pa.amtype
FROM pg_class as pc JOIN pg_am AS pa ON (pc.relam = pa.oid)
...
-- NOTE: we allow attstorage to be /* REPLACED */''plain/* REPLACED */'' even when typstorage is not /* REPLACED */,
