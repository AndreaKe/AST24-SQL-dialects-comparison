...
INSERT INTO rw_view2 VALUES (100); -- ok, but not in view (doesn/* REPLACED */''t fail rw_view1/* REPLACED */''s check)
UPDATE rw_view2 SET a = 200 WHERE a = 5; -- ok, but not in view (doesn/* REPLACED */''t fail rw_view1/* REPLACED */''s check)
SELECT * FROM base_tbl;
...
INSERT INTO rw_view2 VALUES (-10); -- ok, but not in view (doesn/* REPLACED */''t fail rw_view2/* REPLACED */''s check)
INSERT INTO rw_view2 VALUES (5); -- ok
INSERT INTO rw_view2 VALUES (20); -- ok, but not in view (doesn/* REPLACED */''t fail rw_view1/* REPLACED */''s check)
UPDATE rw_view2 SET a = 30 WHERE a = 5; -- ok, but not in view (doesn/* REPLACED */''t fail rw_view1/* REPLACED */''s check)
INSERT INTO rw_view2 VALUES (5); -- ok
UPDATE rw_view2 SET a = -5 WHERE a = 5; -- ok, but not in view (doesn/* REPLACED */''t fail rw_view2/* REPLACED */''s check)
SELECT * FROM base_tbl;
...
INSERT INTO rw_view2 VALUES (2,3); -- ok, but not in view (doesn/* REPLACED */''t fail rw_view2/* REPLACED */''s check)
DROP TABLE base_tbl CASCADE;
