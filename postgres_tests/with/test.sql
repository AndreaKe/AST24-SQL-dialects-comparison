...
-- assignment, because the /* REPLACED */ ''q1/* REPLACED */ '' Var passed down to A/* REPLACED */ ''s targetlist subselect
-- looks exactly like the /* REPLACED */ ''A.id/* REPLACED */ '' Var passed down to C/* REPLACED */ ''s subselect, causing
...
-- check that WITH query is run to completion even if outer query isn/* REPLACED */ ''t
WITH t AS (
...
-- most variants of rules aren/* REPLACED */ ''t allowed
...
-- check that parser lookahead for WITH doesn/* REPLACED */ ''t cause any odd behavior
...
-- surprisingly it works, because CTEs don/* REPLACED */ ''t hide tables from data-modifying
-- statements)
